...
function coffeeshop_scripts() {
	...
	wp_enqueue_style( 'coffeeshop-main', get_template_directory_uri() .'/css/main.css');
	...
	wp_enqueue_script( 'coffeeshop-script', get_template_directory_uri() . '/js/script.js', array('jquery'),  );
...
*/
  function enqueue_custom_fonts(){
   if (!is_admin()) {
	   wp_register_style('source_sans_pro','https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@300;400;700&display=swap ');
	   wp_register_style('nunito','https://fonts.googleapis.com/css2?family=Nunito:wght@400;700&family=Source+Sans+Pro:wght@300;400;700&display=swap ');
